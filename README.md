...
* `customClassesFn` callback function that gets passed a Date object for each day in view. Should return a string consisting of the additional classes to add for that day. 
