...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLeapYear = function isLeapYear(year) {
	  return (// solution by Matti Virkkunen: http://stackoverflow.com/a/4881951
	...
	var compareDates = function compareDates(a, b) {
	  return (// weak date comparison (use setToStartOfDay(date) to ensure correct result)
	    a.getTime() === b.getTime()
	  );
	};
	...
	var extend = function extend(to, from, overwrite) {
	  ...
	  for (prop in from) {
	    ...
	    if (hasProp && (0, _typeof3.default)(from[prop]) === 'object' && from[prop] !== null && from[prop].nodeName === undefined) {
	      if (isDate(from[prop])) {
	        if (overwrite) {
	...
	var Pikaday = function () {
	  function Pikaday(options) {
	    ...
	    (0, _classCallCheck3.default)(this, Pikaday);
	    ...
	    this.addedEvents = [];
	    this.addEvent = function (eventName, el, e, callback, capture) {
	      _this.addedEvents[eventName] = (0, _defineProperty3.default)({
	        el: el,
	        e: e,
	        callback: callback
	      }, 'el', el);
	    ...
	    this.removeEvent = function (eventName, el, e, callback, capture) {
	      el.removeEventListener(e, callback, !!capture);
	      delete _this.addedEvents[eventName];
	    };
	  ...
	  (0, _createClass3.default)(Pikaday, [{
	    key: 'config',
	    ...
	    key: 'parseDate',
	    value: function parseDate(str, format) {
	      var date;
	    ...
	    key: 'clearDate',
	    value: function clearDate(clearField, preventOnClear) {
	      this._d = null;
	      this.draw();
	    ...
	    key: 'adjustDate',
	    value: function adjustDate(sign, days) {
	    ...
	    key: 'setStartRange',
	    value: function setStartRange(value) {
	      this._o.startRange = value;
	    }
	  }, {
	    key: 'setEndRange',
	    value: function setEndRange(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10)(IteratorPrototype, __webpack_require__(51)('iterator'), function(){ return this; });
